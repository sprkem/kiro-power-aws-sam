...
**CRITICAL**: Use Lambda Layers for Powertools, **NEVER** add Powertools to requirements.txt. Query the relevant documentation to get the latest version for a language.
...
**DO NOT** add these to requirements.txt (use layers instead):
...
1. Validate template: `sam validate --template template.yaml`
